 ...
 const Section = () => {
    return(
        ...
        <div className="d-flex justify-content-between">
            ...
            <a className="see" href="#">See All Products</a>
        </div>
        <div className="parent d-grid justify-content-between">
            <div className="child">
                <div className="real-1">
                <img className="img-1" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1440201227_two-sided-business-cards-by-printivo.png" alt="" />
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-2  two">Two-sided Business Cards</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦15,100 <span className="per">per 100</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse Two-sided Bu...<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-2">
                    <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1572522725_flyer-1sided.png" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className=" mt-4 two">A5 flyers (Single Sided)</h5>
                    <p className="starting">starting at</p>
                    <strong  className="strong">₦25,800 <span className="per">per 100</span></strong>
                    <p className="browse border rounded border-1 mt-3">
                        Browse A5 flyers (S...)<i className="fa-solid fa-angle-right"></i>
                    </p>
                </div>
            </div>
            <div className="child">
                <div className="real-2 ">
                    <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1656003107_social-media--15.png" alt="" />
                </div>
                <div className="p-3 div-3">
                    <h5 className=" mt-3 two">Round Stickers (3.5" Diameter)</h5>
                    <p className="starting">starting at</p>
                    <strong className="strong">₦17,000 <span className="per">per 100</span></strong>
                    <p className="browse border rounded border-1 mt-3">
                        Browse Round Sticke...<i className="fa-solid fa-angle-right"></i>
                    </p>
                </div>
            </div>
            <div className="child">
                <div className="real-1">
                    <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1661456358_social-media--16.png" alt="" />
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">simple mugs</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦4,800 <span className="per">per 1</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse Simple Mugs<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-2">
                    <img className="img-1" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1439790190_postcard.jpg" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">Postcards (A6)</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦22,300 <span className="per">per 50</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse Postcards (A...<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-1">
                    <img className="img-1" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1446183154_big%20rollup%20banner.png" alt=""/>
                </div>
                <h5 className="mt-4 two">Roll Up Banners (Big Base)</h5>
                <div className="p-3 div-3">
                    <p className="starting">starting at</p>
                <strong className="strong">₦60,500 <span className="per">per 1</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse Roll Up Bann...<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-2">
                    <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1572259118_product-5-(1).png" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">A2 Posters</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦71,100 <span className="per">per 100</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse A2 Posters<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-1">
                    <img className="img-1" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1473167305_trifold-brochure-printing.png" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">Trifold Brochures</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦47,500 <span className="per">per 100</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse Trifold Broc...<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-2">
                    <img className="img-1" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1456215784_12.png" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">Landscape ID Cards</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦4,500 <span className="per">per 1</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse Landscape ID...<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-1">
                    <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1485151940_White-tshirt.png" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">Off White T-shirts</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦6,000 <span className="per">per 1</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse Off White T-...<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-2">
                    <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1572258123_product-3-(1).png" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">A4 Branded Paper Bags</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦115,280 <span className="per">per 100</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse A4 Branded P...<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
            <div className="child">
                <div className="real-2">
                    <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1607424257_63f28e7a-da1d-4685-a297-964e186a2170.jpeg" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">A4 Courier Bags</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦27,5000<span className="per">per 100</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse A4 Courier B...<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
        </div>
    ...
    <section className="section-1 ">
        <div className="d-flex justify-content-between">
            ...
            <a className="see" href="">See All Categories</a>
        </div>
        <div className="parent-1 mt-5 d-flex gap-5">
            <div className="child-1">
              <div className="real-1">
                <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1473159158_Christmas-card-for-this-wonderful-season.png" alt=""/>
              </div>  
              <div className="p-3 div-3">
                <h5 className="mt-3 two">Greeting Cards</h5>
                <p className="starting">starting at</p>
            <strong className="strong">₦29,800 <span className="per">per 50</span></strong>
            <p className="browse border rounded border-1 mt-3">
                Browse Greeting Car...<i className="fa-solid fa-angle-right"></i>
            </p>
            </div>
            </div>
            <div className="child-1">
                <div className="real-2">
                    <img className="img-2" src="https://printivo.s3-us-west-2.amazonaws.com/files/category_thumbnails/1473165427_stickers.png" alt=""/>
                </div>
                <div className="p-3 div-3">
                    <h5 className="mt-3 two">Stickers</h5>
                    <p className="starting">starting at</p>
                <strong className="strong">₦5,400 <span className="per">per 75</span></strong>
                <p className="browse border rounded border-1 mt-3">
                    Browse Stickers<i className="fa-solid fa-angle-right"></i>
                </p>
                </div>
            </div>
        </div>
    ...
    <section className="section-2">
        ...
        <div className="sam d-flex mt-5">
            ...
            <div className="pin d-flex gap-4">
                ...
                <div className="mt-1 position-relative">
                    <h6>Oluwatosin <a className="del" href="">@tosingirlfx</a></h6>
                    <p>
                        <span className="span-1">@Printivo</span> delivered my mugs in 24hrs. Thank you so much! It's nice doing business with you. More to come. 
                    </p>
                </div>
            </div>
            <div className="pin d-flex gap-4">
                ...
                <div className="mt-1 position-relative">
                    <h6>Oluwatosin <a className="del" href="">@olgablark</a></h6>
                    <p>
                        These guys <span className="span-1">@Printivo</span> are really awesome and affordable. Excellent customer service and delivery too. Thank you.   
                    </p>
                </div>
            </div>
        </div>
    ...
    <section className="section-3">
        <div>
            <h2 className="you">You can count on us for:</h2>
        </div>
        <div className="kim d-flex mt-3 justify-content-between">
            <div className="tyle d-flex">
                <div>
                ...
                <div className="mt-1">
                    <h6 className="fast">
                        Fast Turnaround Within Days</h6>
                        <p className="order">
