    ...
    <>
      <header>
        <div className="nav d-flex justify-content-around">
          <p style={{ color: "#506683" }} className="cost">
            Cost Calculator
          </p>
          <p style={{ color: "#506683" }} className="cost">
            Discover Stores
          ...
          <p style={{ color: "#506683" }} className="cost">
            Need help? Call: <br />
            <span className="num" style={{ color: "#1da1f2" }}>
              +2347069000083
            </span>{" "}
            or
            <span className="num" style={{ color: "#1da1f2" }}>
          ...
          <p className="flag p-2">
            <img
              ...
              alt="Nigeria Flag"
            />
            <span style={{ color: "#506683" }} className="cost-1">
              Nigeria
            </span>
          </p>
        </div>

        <nav className="div-1" id="stick">
          <div className="d-flex justify-content-around align-items-center flexy">
            <img
              width="150"
            ...
            <div id="menubar" className="menubar">
              <div className="d-flex mobile-menu gap-4 align-items-center">
                <p className="product">All Products</p>
                <p className="product">Become a Reseller</p>
                <p className="product">Merch Store</p>
                <p className="product">Marketplace</p>
                <p>
                  <a
                    className="sign"
                    href="https://printivo.com/members/sign-up"
                  >
                    Sign in
                  </a>
                </p>
                <p className="product">Create Account</p>
                <img
                  className="produc"
            ...
            {/* <div id="menuIcon" onClick={clickMe}>
              <i id="hamburger" className="fa-solid fa-bars"></i>
            </div> */}
          </div>
        </nav>
      </header>
